  ...
  return (
    <div className="bk-root">
      <div className="bk-title-bar">
        ...
        <span className="bk-title-bar__text">Reminders</span>
                ...
                <div className="am-lookup-grid">
                  ...
                  <Field label="Branch ID" required>
                    <div className="am-input-group">
                      <input className="bk-input am-input-sm" value={rec.branchId}
                        disabled={isDisabled} onChange={e => patch({ branchId: e.target.value })} />
                      <input className="bk-input" value={rec.branchName}
                  ...
                  <Field label="Account Number" required>
                    <div className="am-input-group">
                      <input className="bk-input am-input-sm" value={rec.accountNumber}
                        disabled={isDisabled} onChange={e => patch({ accountNumber: e.target.value })} />
                      <input className="bk-input" value={rec.accountTitle} disabled
                  ...
                  <Field label="Reminder ID">
                    <div className="am-input-group">
                      <input className="bk-input" value={rec.reminderId}
              ...
              <div className="bk-panel__body">
                <div className="am-form-grid">
                  ...
                  <Field label="From Date" required>
                    <select className="bk-select" value={rec.fromDate}
                  ...
                  <Field label="To Date" required>
                    <select className="bk-select" value={rec.toDate}
