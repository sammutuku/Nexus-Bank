  ...
  return (
    <div className="bk-root">
      <div className="bk-title-bar">
        ...
        <span className="bk-title-bar__text">Standing Instruction Transfer</span>
        ...
        <main className="bk-main">
          <div className="bk-tab-content">
            ...
            <div className="bk-panel">
              <div className="bk-panel__header">Standing Instruction Details</div>
              <div className="bk-panel__body">

                {/* Branch ID row */}
                <div className="sit-row">
                  <label className="sit-label">Branch ID</label>
                  <input className="bk-input sit-input-sm" value={rec.branchId} disabled={isDisabled}
                    onChange={e => patch({ branchId: e.target.value })} />
                  <input className="bk-input sit-input-lg" value={rec.branchName} disabled={isDisabled}
                ...
                <div className="sit-row">
                  ...
                  <input className="bk-input sit-input-lg" value={rec.siId} disabled={isDisabled}
                  ...
                  <input className="bk-input sit-input-lg" value={rec.referenceNo} disabled={isDisabled}
                ...
                <div className="sit-row">
                  ...
                  <input className="bk-input sit-input-sm" value={rec.accountNumber} disabled={isDisabled}
                    onChange={e => patch({ accountNumber: e.target.value })} />
                  <input className="bk-input sit-input-lg" value={rec.accountTitle} disabled
                ...
                <div className="sit-row">
                  ...
                  <select className="bk-select sit-input-lg" value={rec.siType} disabled={isDisabled}
                  ...
                  <select className="bk-select sit-input-lg" value={rec.effectiveDate} disabled={isDisabled}
                ...
                <div className="sit-row">
                  ...
                  <input className="bk-input sit-input-sm" value={rec.transferCurrencyId} disabled={isDisabled}
                    onChange={e => patch({ transferCurrencyId: e.target.value })} />
                  <input className="bk-input sit-input-lg" value={rec.transferCurrencyName} disabled
                ...
                <div className="sit-row">
                  ...
                  <select className="bk-select sit-input-lg" value={rec.amountIn} disabled={isDisabled}
                  ...
                  <input className="bk-input bk-input--money sit-input-lg" value={rec.amount} disabled={isDisabled}
                ...
                <div className="sit-row">
                  ...
                  <select className="bk-select sit-input-lg" value={rec.transferFrequency} disabled={isDisabled}
                  ...
                  <input className="bk-input sit-input-lg" type="number" value={rec.noOfExecution} disabled={isDisabled}
                ...
                <div className="sit-row">
                  ...
                  <input className="bk-input sit-input-lg" value={rec.regularExecutionDay} disabled={isDisabled}
                ...
                <div className="sit-row">
                  ...
                  <select className="bk-select sit-input-lg" value={rec.firstExecutionDate} disabled={isDisabled}
                  ...
                  <input className="bk-input sit-input-lg" value={rec.lastExecutionDate} disabled={isDisabled}
                ...
                <div className="sit-row">
                  ...
                  <select className="bk-select sit-input-lg" value={rec.chargeRecovery} disabled={isDisabled}
            ...
            <div className="bk-panel">
              <div className="bk-panel__header">Beneficiary Account Details</div>
              <div className="bk-panel__body">
                <div className="sit-row">
                  <label className="sit-label sit-label--req">Branch ID</label>
                  <input className="bk-input sit-input-sm" value={rec.benBranchId} disabled={isDisabled}
                    onChange={e => patch({ benBranchId: e.target.value })} />
                  <input className="bk-input sit-input-lg" value={rec.benBranchName} disabled
                ...
                <div className="sit-row">
                  <label className="sit-label sit-label--req">Account Number</label>
                  <input className="bk-input sit-input-sm" value={rec.benAccountNumber} disabled={isDisabled}
                    onChange={e => patch({ benAccountNumber: e.target.value })} />
                  <input className="bk-input sit-input-lg" value={rec.benAccountTitle} disabled
              ...
              <div className="bk-panel__body">
                <div className="sit-additional-grid">
                  <div className="sit-row">
                    ...
                    <input className="bk-input sit-input-lg" value={rec.nextExecutionDate} readOnly
                      style={{ background: 'var(--bank-bg-alt)' }} />
                    <div className="sit-spacer" />
                    <label className="sit-label-right">Standing Instruction Status</label>
                    <input className="bk-input sit-input-lg" value={rec.siStatus} readOnly
                      style={{ background: 'var(--bank-bg-alt)' }} />
                  </div>
                  <div className="sit-row">
                    <label className="sit-label">Last Run Date</label>
                    <input className="bk-input sit-input-lg" value={rec.lastRunDate} readOnly
                      style={{ background: 'var(--bank-bg-alt)' }} />
                    <div className="sit-spacer" />
                    <label className="sit-label-right">Last Run Status</label>
                    <input className="bk-input sit-input-lg" value={rec.lastRunStatus} readOnly
                      style={{ background: 'var(--bank-bg-alt)' }} />
                  </div>
                  <div className="sit-row">
                    <label className="sit-label">No Of Times Failed</label>
                    <input className="bk-input sit-input-lg" value={rec.noOfTimesFailed} readOnly
                      style={{ background: 'var(--bank-bg-alt)' }} />
                    <div className="sit-spacer" />
                    <div className="sit-spacer" />
                    <div className="sit-spacer" />
                  ...
                  <div className="sit-row">
                    ...
                    <input className="bk-input" value={rec.stoppedReason} readOnly
            ...
            <div className="bk-audit">
              ...
              <div className="bk-audit__grid">
                <div className="bk-audit__row">
                  ...
                  <span className="bk-audit__label">Stopped By</span>
                  <span className="bk-audit__value">{rec.stoppedBy}</span>
                ...
                <div className="bk-audit__row">
                  ...
                  <span className="bk-audit__label">Stopped On</span>
                  <span className="bk-audit__value">{rec.stoppedOn}</span>
