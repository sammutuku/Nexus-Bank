  ...
  return (
    <div className="bk-root">
      <div className="bk-title-bar">
        ...
        <span className="bk-title-bar__text">Activate Dormant Account</span>
              ...
              <div className="bk-panel__body">
                <div className="am-form-grid">
                  ...
                  <Field label="Instructed By" required>
                    <div className="am-input-group">
                      <input className="bk-input am-input-sm" value={rec.instructedBy}
                        disabled={isDisabled} onChange={e => patch({ instructedBy: e.target.value })} />
                      <input className="bk-input" value={rec.instructedByName} disabled
